...
# Created by write_sdc on Wed Apr 8 07:28:21 2020

###################################################################
set sdc_version 2.1

set_load -pin_load ${PIN_LOAD} [get_ports {wptr_r_o[9]}]
...
set_load -pin_load ${PIN_LOAD} [get_ports {rptr_r_o[9]}]
...
set_load -pin_load ${PIN_LOAD} [get_ports {rptr_n_o[9]}]
...
set_output_delay -clock clk  0  [get_ports {wptr_r_o[9]}]
...
set_output_delay -clock clk  0  [get_ports {rptr_r_o[9]}]
...
set_output_delay -clock clk  0  [get_ports {rptr_n_o[9]}]
