...
# Created by write_sdc on Wed Apr 8 02:50:00 2020
...
set_load -pin_load ${PIN_LOAD} [get_ports kerr_o]
...
set_input_delay -clock vclk  0  [get_ports k_i]
...
set_output_delay -clock vclk  0  [get_ports kerr_o]
