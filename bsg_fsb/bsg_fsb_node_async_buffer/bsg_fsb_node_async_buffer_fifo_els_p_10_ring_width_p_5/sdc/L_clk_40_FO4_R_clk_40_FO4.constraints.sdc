...
# Created by write_sdc on Wed Jan 22 15:55:10 2020
...
create_clock [get_ports L_clk_i]  -name L_clk  -period ${FO4_40} -waveform {0 ${FO4_40_DIV_2}}
...
set_max_delay 20 -from [get_clocks L_clk] -to [get_clocks R_clk] -ignore_clock_latency
set_min_delay 0 -from [get_clocks L_clk] -to [get_clocks R_clk] -ignore_clock_latency
set_max_delay 20 -from [get_clocks R_clk] -to [get_clocks L_clk] -ignore_clock_latency
