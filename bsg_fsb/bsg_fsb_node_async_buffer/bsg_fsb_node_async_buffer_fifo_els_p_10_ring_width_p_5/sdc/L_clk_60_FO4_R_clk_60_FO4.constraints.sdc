...
# Created by write_sdc on Wed Jan 22 15:55:35 2020
...
set_max_delay 30 -from [get_clocks L_clk] -to [get_clocks R_clk] -ignore_clock_latency
set_min_delay 0 -from [get_clocks L_clk] -to [get_clocks R_clk] -ignore_clock_latency
set_max_delay 30 -from [get_clocks R_clk] -to [get_clocks L_clk] -ignore_clock_latency
