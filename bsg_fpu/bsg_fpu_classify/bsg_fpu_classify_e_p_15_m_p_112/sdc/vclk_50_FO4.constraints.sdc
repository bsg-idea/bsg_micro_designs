...
# Created by write_sdc on Sun Jan 19 23:58:19 2020

###################################################################
set sdc_version 2.1

set_load -pin_load ${PIN_LOAD} [get_ports {class_o[127]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[126]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[125]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[124]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[123]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[122]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[121]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[120]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[119]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[118]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[117]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[116]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[115]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[114]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[113]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[112]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[111]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[110]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[109]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[108]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[107]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[106]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[105]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[104]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[103]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[102]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[101]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[100]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[99]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[98]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[97]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[96]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[95]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[94]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[93]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[92]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[91]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[90]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[89]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[88]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[87]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[86]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[85]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[84]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[83]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[82]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[81]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[80]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[79]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[78]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[77]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[76]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[75]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[74]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[73]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[72]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[71]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[70]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[69]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[68]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[67]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[66]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[65]}]
set_load -pin_load ${PIN_LOAD} [get_ports {class_o[64]}]
...
set_output_delay -clock vclk  0  [get_ports {class_o[127]}]
set_output_delay -clock vclk  0  [get_ports {class_o[126]}]
set_output_delay -clock vclk  0  [get_ports {class_o[125]}]
set_output_delay -clock vclk  0  [get_ports {class_o[124]}]
set_output_delay -clock vclk  0  [get_ports {class_o[123]}]
set_output_delay -clock vclk  0  [get_ports {class_o[122]}]
set_output_delay -clock vclk  0  [get_ports {class_o[121]}]
set_output_delay -clock vclk  0  [get_ports {class_o[120]}]
set_output_delay -clock vclk  0  [get_ports {class_o[119]}]
set_output_delay -clock vclk  0  [get_ports {class_o[118]}]
set_output_delay -clock vclk  0  [get_ports {class_o[117]}]
set_output_delay -clock vclk  0  [get_ports {class_o[116]}]
set_output_delay -clock vclk  0  [get_ports {class_o[115]}]
set_output_delay -clock vclk  0  [get_ports {class_o[114]}]
set_output_delay -clock vclk  0  [get_ports {class_o[113]}]
set_output_delay -clock vclk  0  [get_ports {class_o[112]}]
set_output_delay -clock vclk  0  [get_ports {class_o[111]}]
set_output_delay -clock vclk  0  [get_ports {class_o[110]}]
set_output_delay -clock vclk  0  [get_ports {class_o[109]}]
set_output_delay -clock vclk  0  [get_ports {class_o[108]}]
set_output_delay -clock vclk  0  [get_ports {class_o[107]}]
set_output_delay -clock vclk  0  [get_ports {class_o[106]}]
set_output_delay -clock vclk  0  [get_ports {class_o[105]}]
set_output_delay -clock vclk  0  [get_ports {class_o[104]}]
set_output_delay -clock vclk  0  [get_ports {class_o[103]}]
set_output_delay -clock vclk  0  [get_ports {class_o[102]}]
set_output_delay -clock vclk  0  [get_ports {class_o[101]}]
set_output_delay -clock vclk  0  [get_ports {class_o[100]}]
set_output_delay -clock vclk  0  [get_ports {class_o[99]}]
set_output_delay -clock vclk  0  [get_ports {class_o[98]}]
set_output_delay -clock vclk  0  [get_ports {class_o[97]}]
set_output_delay -clock vclk  0  [get_ports {class_o[96]}]
set_output_delay -clock vclk  0  [get_ports {class_o[95]}]
set_output_delay -clock vclk  0  [get_ports {class_o[94]}]
set_output_delay -clock vclk  0  [get_ports {class_o[93]}]
set_output_delay -clock vclk  0  [get_ports {class_o[92]}]
set_output_delay -clock vclk  0  [get_ports {class_o[91]}]
set_output_delay -clock vclk  0  [get_ports {class_o[90]}]
set_output_delay -clock vclk  0  [get_ports {class_o[89]}]
set_output_delay -clock vclk  0  [get_ports {class_o[88]}]
set_output_delay -clock vclk  0  [get_ports {class_o[87]}]
set_output_delay -clock vclk  0  [get_ports {class_o[86]}]
set_output_delay -clock vclk  0  [get_ports {class_o[85]}]
set_output_delay -clock vclk  0  [get_ports {class_o[84]}]
set_output_delay -clock vclk  0  [get_ports {class_o[83]}]
set_output_delay -clock vclk  0  [get_ports {class_o[82]}]
set_output_delay -clock vclk  0  [get_ports {class_o[81]}]
set_output_delay -clock vclk  0  [get_ports {class_o[80]}]
set_output_delay -clock vclk  0  [get_ports {class_o[79]}]
set_output_delay -clock vclk  0  [get_ports {class_o[78]}]
set_output_delay -clock vclk  0  [get_ports {class_o[77]}]
set_output_delay -clock vclk  0  [get_ports {class_o[76]}]
set_output_delay -clock vclk  0  [get_ports {class_o[75]}]
set_output_delay -clock vclk  0  [get_ports {class_o[74]}]
set_output_delay -clock vclk  0  [get_ports {class_o[73]}]
set_output_delay -clock vclk  0  [get_ports {class_o[72]}]
set_output_delay -clock vclk  0  [get_ports {class_o[71]}]
set_output_delay -clock vclk  0  [get_ports {class_o[70]}]
set_output_delay -clock vclk  0  [get_ports {class_o[69]}]
set_output_delay -clock vclk  0  [get_ports {class_o[68]}]
set_output_delay -clock vclk  0  [get_ports {class_o[67]}]
set_output_delay -clock vclk  0  [get_ports {class_o[66]}]
set_output_delay -clock vclk  0  [get_ports {class_o[65]}]
set_output_delay -clock vclk  0  [get_ports {class_o[64]}]
