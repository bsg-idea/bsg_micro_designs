...
# Created by write_sdc on Sun Jan 19 21:44:28 2020

###################################################################
set sdc_version 2.1

set_load -pin_load 1.5 [get_ports {addr_o[6]}]
set_load -pin_load 1.5 [get_ports {addr_o[5]}]
set_load -pin_load 1.5 [get_ports {addr_o[4]}]
