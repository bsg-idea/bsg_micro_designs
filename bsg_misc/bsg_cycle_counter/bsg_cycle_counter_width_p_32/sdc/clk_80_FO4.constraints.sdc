...
# Created by write_sdc on Mon Mar 13 20:39:17 2023

###################################################################
set sdc_version 2.1

set_load -pin_load 1 [get_ports {ctr_r_o[31]}]
set_load -pin_load 1 [get_ports {ctr_r_o[30]}]
set_load -pin_load 1 [get_ports {ctr_r_o[29]}]
set_load -pin_load 1 [get_ports {ctr_r_o[28]}]
set_load -pin_load 1 [get_ports {ctr_r_o[27]}]
set_load -pin_load 1 [get_ports {ctr_r_o[26]}]
set_load -pin_load 1 [get_ports {ctr_r_o[25]}]
set_load -pin_load 1 [get_ports {ctr_r_o[24]}]
set_load -pin_load 1 [get_ports {ctr_r_o[23]}]
set_load -pin_load 1 [get_ports {ctr_r_o[22]}]
set_load -pin_load 1 [get_ports {ctr_r_o[21]}]
set_load -pin_load 1 [get_ports {ctr_r_o[20]}]
set_load -pin_load 1 [get_ports {ctr_r_o[19]}]
set_load -pin_load 1 [get_ports {ctr_r_o[18]}]
set_load -pin_load 1 [get_ports {ctr_r_o[17]}]
set_load -pin_load 1 [get_ports {ctr_r_o[16]}]
