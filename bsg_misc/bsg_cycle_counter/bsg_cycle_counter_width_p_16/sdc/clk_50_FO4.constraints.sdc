...
# Created by write_sdc on Tue Feb 14 11:16:11 2023

###################################################################
set sdc_version 2.1

set_load -pin_load 1 [get_ports {ctr_r_o[15]}]
set_load -pin_load 1 [get_ports {ctr_r_o[14]}]
set_load -pin_load 1 [get_ports {ctr_r_o[13]}]
set_load -pin_load 1 [get_ports {ctr_r_o[12]}]
set_load -pin_load 1 [get_ports {ctr_r_o[11]}]
set_load -pin_load 1 [get_ports {ctr_r_o[10]}]
set_load -pin_load 1 [get_ports {ctr_r_o[9]}]
set_load -pin_load 1 [get_ports {ctr_r_o[8]}]
set_load -pin_load 1 [get_ports {ctr_r_o[7]}]
set_load -pin_load 1 [get_ports {ctr_r_o[6]}]
set_load -pin_load 1 [get_ports {ctr_r_o[5]}]
set_load -pin_load 1 [get_ports {ctr_r_o[4]}]
set_load -pin_load 1 [get_ports {ctr_r_o[3]}]
set_load -pin_load 1 [get_ports {ctr_r_o[2]}]
set_load -pin_load 1 [get_ports {ctr_r_o[1]}]
set_load -pin_load 1 [get_ports {ctr_r_o[0]}]
