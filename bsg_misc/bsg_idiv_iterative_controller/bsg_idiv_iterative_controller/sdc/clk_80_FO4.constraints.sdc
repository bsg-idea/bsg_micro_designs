...
set_load -pin_load 1.5 [get_ports opA_sel_o]
set_load -pin_load 1.5 [get_ports opA_ld_o]
set_load -pin_load 1.5 [get_ports opA_inv_o]
set_load -pin_load 1.5 [get_ports opA_clr_l_o]
set_load -pin_load 1.5 [get_ports {opB_sel_o[2]}]
set_load -pin_load 1.5 [get_ports {opB_sel_o[1]}]
set_load -pin_load 1.5 [get_ports {opB_sel_o[0]}]
set_load -pin_load 1.5 [get_ports opB_ld_o]
set_load -pin_load 1.5 [get_ports opB_inv_o]
set_load -pin_load 1.5 [get_ports opB_clr_l_o]
set_load -pin_load 1.5 [get_ports {opC_sel_o[2]}]
set_load -pin_load 1.5 [get_ports {opC_sel_o[1]}]
set_load -pin_load 1.5 [get_ports {opC_sel_o[0]}]
set_load -pin_load 1.5 [get_ports opC_ld_o]
set_load -pin_load 1.5 [get_ports latch_inputs_o]
set_load -pin_load 1.5 [get_ports adder_cin_o]
