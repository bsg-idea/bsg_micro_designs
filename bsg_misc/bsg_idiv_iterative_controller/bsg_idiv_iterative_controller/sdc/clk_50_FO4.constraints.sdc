...
# Created by write_sdc on Mon Mar 13 20:50:49 2023

###################################################################
set sdc_version 2.1

set_load -pin_load 1 [get_ports ready_and_o]
set_load -pin_load 1 [get_ports {opA_sel_o[1]}]
set_load -pin_load 1 [get_ports {opA_sel_o[0]}]
...
set_load -pin_load 1 [get_ports latch_signed_div_o]
set_load -pin_load 1 [get_ports adder1_cin_o]
...
set_input_delay -clock clk  0  [get_ports adder1_result_is_neg_i]
set_input_delay -clock clk  0  [get_ports adder2_result_is_neg_i]
...
set_output_delay -clock clk  0  [get_ports {opA_sel_o[1]}]
set_output_delay -clock clk  0  [get_ports {opA_sel_o[0]}]
...
set_output_delay -clock clk  0  [get_ports latch_signed_div_o]
set_output_delay -clock clk  0  [get_ports adder1_cin_o]
